...
function createCommandRunner(runFn, argsArray = []) {
  ...
  return Array.isArray(argsArray) && argsArray.length > 0
    ? () => runFn(...argsArray)
    : runFn;
}
...
function buildCommandPaletteActions() {
  return [
    ...
    createCommandItem(PATTERN_CMD_SECTION.ENTRY, "Toggle Favorite", () =>
    ...
    createCommandItem(PATTERN_CMD_SECTION.VIEW, "Explorer Layout: Standard", setExplorerLayoutMode, EXPLORER_LAYOUT_NORMAL),
    createCommandItem(PATTERN_CMD_SECTION.VIEW, "Explorer Layout: Compact", setExplorerLayoutMode, EXPLORER_LAYOUT_COMPACT),
    createCommandItem(PATTERN_CMD_SECTION.VIEW, "Explorer Layout: Focus", setExplorerLayoutMode, EXPLORER_LAYOUT_MAXIMIZED),
    createCommandItem(PATTERN_CMD_SECTION.APPEARANCE, "Theme: Enterprise", updateUiThemePreference, "enterprise"),
    createCommandItem(PATTERN_CMD_SECTION.APPEARANCE, "Theme: Windows 11 Dark", updateUiThemePreference, "futuristic"),
    ...
    createCommandItem(PATTERN_CMD_SECTION.UNIVERSE, "Create Custom Set from Selection", createUniverseCustomSetFromSelection, ""),
