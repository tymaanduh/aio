...
(function (root, factory) {
  ...
  function renderClusterPanel() {
    ...
    if (!(G_DOM.universeClusterList instanceof HTMLElement) || !(G_DOM.universeClusterSummary instanceof HTMLElement)) {
      return;
    }
  ...
  function requestGraphBuildNow() {
    ...
    G_APP.s.activeView === VIEW_UNIVERSE &&
      G_DOM.universeSummary instanceof HTMLElement &&
      (G_DOM.universeSummary.textContent = "Building word universe...");
    try {
