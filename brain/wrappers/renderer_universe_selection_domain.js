...
function fitUniverseCamera() {
  ...
  const next = runExtractedFunction(
    PATTERN_EXTRACTED_MODULE.MATH_CAMERA,
    "compute_fit_camera",
    [input],
