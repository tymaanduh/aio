...
(function (root, factory) {
  ...
  function syncUiSettingsControls() {
    ...
    G_DOM.uiThemeEnterpriseInput instanceof HTMLInputElement &&
      (G_DOM.uiThemeEnterpriseInput.checked = theme === "enterprise");
    G_DOM.uiThemeFuturisticInput instanceof HTMLInputElement &&
      (G_DOM.uiThemeFuturisticInput.checked = theme === "futuristic");
    G_DOM.uiThemeMonochromeInput instanceof HTMLInputElement &&
      (G_DOM.uiThemeMonochromeInput.checked = theme === "monochrome");
    G_DOM.uiReduceMotionInput instanceof HTMLInputElement &&
      (G_DOM.uiReduceMotionInput.checked = Boolean(G_UNI.ui.prefs?.reduceMotion));
  }
  ...
  function closeUiSettingsPopover({ restoreFocus = true } = {}) {
    ...
    if (restoreFocus) {
      ...
      const target =
        G_RT.uiSettingsRestoreFocusElement instanceof HTMLElement ? G_RT.uiSettingsRestoreFocusElement : fallback;
      target.focus();
    }
  }
