...
const PATTERN_SCOPE_ORDER = Object.freeze({
...
const PATTERN_STAGE_ORDER = Object.freeze({
...
function compare_chain_records(a, b) {
  const stage_delta = (PATTERN_STAGE_ORDER[a.stage] || 0) - (PATTERN_STAGE_ORDER[b.stage] || 0);
  if (stage_delta !== 0) {
    return stage_delta;
  }
