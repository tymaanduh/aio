// Auto-generated C++ equivalent module proxy for renderer/windows/logs_window/window_shell.js.
#include "../../../_shared/repo_module_proxy.hpp"

#include <string>
#include <vector>

static constexpr const char* AIO_SOURCE_JS_FILE = "renderer/windows/logs_window/window_shell.js";

namespace aio::repo_polyglot_equivalents::renderer::windows::logs_window::window_shell {
...
inline int run_logs_window_shell(const std::string& args_json = "[]") {
  return aio::repo_module_proxy::run_invoke_function(source_js_file(), "run_logs_window_shell", args_json);
}
