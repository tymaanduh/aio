...
AIO_SOURCE_JS_FILE = "scripts/reset-and-benchmark-polyglot-runtime.js"
...
def remove_path_if_exists(*args, **kwargs):
    return invoke_source_function("removePathIfExists", *args, **kwargs)

def run_reset_and_benchmark(*args, **kwargs):
    return invoke_source_function("runResetAndBenchmark", *args, **kwargs)

def to_posix(*args, **kwargs):
    return invoke_source_function("toPosix", *args, **kwargs)

def to_slug(*args, **kwargs):
    return invoke_source_function("toSlug", *args, **kwargs)
