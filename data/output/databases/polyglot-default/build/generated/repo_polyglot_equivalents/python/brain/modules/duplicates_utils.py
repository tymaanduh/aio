...
AIO_SOURCE_JS_FILE = "brain/modules/duplicates_utils.js"
...
def build_near_duplicate_cluster(*args, **kwargs):
    return invoke_source_function("buildNearDuplicateCluster", *args, **kwargs)

def jaccard_similarity(*args, **kwargs):
    return invoke_source_function("jaccardSimilarity", *args, **kwargs)

def normalize_word_lower(*args, **kwargs):
    return invoke_source_function("normalizeWordLower", *args, **kwargs)

def tokenize(*args, **kwargs):
    return invoke_source_function("tokenize", *args, **kwargs)
