...
AIO_SOURCE_JS_FILE = "scripts/validate-script-swap-catalog.js"
...
def load_json(*args, **kwargs):
    return invoke_source_function("loadJson", *args, **kwargs)
...
def run_validation(*args, **kwargs):
    return invoke_source_function("runValidation", *args, **kwargs)
