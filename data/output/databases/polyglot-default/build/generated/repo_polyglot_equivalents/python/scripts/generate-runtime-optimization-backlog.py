...
AIO_SOURCE_JS_FILE = "scripts/generate-runtime-optimization-backlog.js"
...
def add_task(*args, **kwargs):
    return invoke_source_function("addTask", *args, **kwargs)

def build_tasks(*args, **kwargs):
    return invoke_source_function("buildTasks", *args, **kwargs)
...
def to_markdown(*args, **kwargs):
    return invoke_source_function("toMarkdown", *args, **kwargs)
