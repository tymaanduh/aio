...
AIO_SOURCE_JS_FILE = "scripts/validate-codex-desktop-compat.js"
...
def parse_frontmatter(*args, **kwargs):
    return invoke_source_function("parseFrontmatter", *args, **kwargs)

def parse_yaml_file(*args, **kwargs):
    return invoke_source_function("parseYamlFile", *args, **kwargs)

def read_text(*args, **kwargs):
    return invoke_source_function("readText", *args, **kwargs)

def validate_skill(*args, **kwargs):
    return invoke_source_function("validateSkill", *args, **kwargs)
