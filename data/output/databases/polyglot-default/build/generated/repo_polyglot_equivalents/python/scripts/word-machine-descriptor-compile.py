...
AIO_SOURCE_JS_FILE = "scripts/word-machine-descriptor-compile.js"
...
def create_memory_bridge_repository(*args, **kwargs):
    return invoke_source_function("createMemoryBridgeRepository", *args, **kwargs)
...
def read_text_file(*args, **kwargs):
    return invoke_source_function("readTextFile", *args, **kwargs)
