...
AIO_SOURCE_JS_FILE = "scripts/run-local-token-maintenance.js"
...
def build_efficiency_summary(*args, **kwargs):
    return invoke_source_function("buildEfficiencySummary", *args, **kwargs)
...
def run_local_token_maintenance(*args, **kwargs):
    return invoke_source_function("runLocalTokenMaintenance", *args, **kwargs)
