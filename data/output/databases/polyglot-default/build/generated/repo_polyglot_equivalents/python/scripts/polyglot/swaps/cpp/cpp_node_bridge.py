...
AIO_SOURCE_JS_FILE = "scripts/polyglot/swaps/cpp/cpp_node_bridge.js"
...
def build_bridge_binary(*args, **kwargs):
    return invoke_source_function("buildBridgeBinary", *args, **kwargs)
...
def resolve_compiler(*args, **kwargs):
    return invoke_source_function("resolveCompiler", *args, **kwargs)

def run_command(*args, **kwargs):
    return invoke_source_function("runCommand", *args, **kwargs)

def should_rebuild_binary(*args, **kwargs):
    return invoke_source_function("shouldRebuildBinary", *args, **kwargs)
