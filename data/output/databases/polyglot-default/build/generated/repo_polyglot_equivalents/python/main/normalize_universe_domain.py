...
AIO_SOURCE_JS_FILE = "main/normalize_universe_domain.js"
...
def normalize_universe_cache_state(*args, **kwargs):
    return invoke_source_function("normalizeUniverseCacheState", *args, **kwargs)

def normalize_universe_graph_edge(*args, **kwargs):
    return invoke_source_function("normalizeUniverseGraphEdge", *args, **kwargs)

def normalize_universe_graph_node(*args, **kwargs):
    return invoke_source_function("normalizeUniverseGraphNode", *args, **kwargs)
