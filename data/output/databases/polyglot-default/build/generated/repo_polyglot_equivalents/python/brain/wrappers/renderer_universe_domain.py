...
AIO_SOURCE_JS_FILE = "brain/wrappers/renderer_universe_domain.js"
...
def on_remove(*args, **kwargs):
    return invoke_source_function("onRemove", *args, **kwargs)

def queue_cache_save(*args, **kwargs):
    return invoke_source_function("queueCacheSave", *args, **kwargs)

def render_cluster_panel(*args, **kwargs):
    return invoke_source_function("renderClusterPanel", *args, **kwargs)

def render_universe_graph(*args, **kwargs):
    return invoke_source_function("renderUniverseGraph", *args, **kwargs)
