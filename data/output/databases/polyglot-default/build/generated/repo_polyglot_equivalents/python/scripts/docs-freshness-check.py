...
AIO_SOURCE_JS_FILE = "scripts/docs-freshness-check.js"
...
def git(*args, **kwargs):
    return invoke_source_function("git", *args, **kwargs)
...
def read_changed_files(*args, **kwargs):
    return invoke_source_function("readChangedFiles", *args, **kwargs)

def rule_matched(*args, **kwargs):
    return invoke_source_function("ruleMatched", *args, **kwargs)
