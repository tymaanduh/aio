...
AIO_SOURCE_JS_FILE = "brain/modules/migration_utils.js"
...
def migrate_state_to_v4(*args, **kwargs):
    return invoke_source_function("migrateStateToV4", *args, **kwargs)
...
def normalize_legacy_entry(*args, **kwargs):
    return invoke_source_function("normalizeLegacyEntry", *args, **kwargs)

def trim_text(*args, **kwargs):
    return invoke_source_function("trimText", *args, **kwargs)
