...
module Aio
  ...
  "validateSkill": "validate_skill"
      ...
      def self.parse_frontmatter(*args, **kwargs)
        invoke_source_function("parseFrontmatter", *args, **kwargs)
      end

      def self.parse_yaml_file(*args, **kwargs)
        invoke_source_function("parseYamlFile", *args, **kwargs)
      end
      ...
      def self.validate_skill(*args, **kwargs)
        invoke_source_function("validateSkill", *args, **kwargs)
      end
    end
  end
end
