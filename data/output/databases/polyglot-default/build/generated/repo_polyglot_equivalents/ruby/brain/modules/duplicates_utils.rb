...
module Aio
  ...
  "tokenize": "tokenize"
      ...
      def self.build_near_duplicate_cluster(*args, **kwargs)
        invoke_source_function("buildNearDuplicateCluster", *args, **kwargs)
      end

      def self.jaccard_similarity(*args, **kwargs)
        invoke_source_function("jaccardSimilarity", *args, **kwargs)
      end
      ...
      def self.tokenize(*args, **kwargs)
        invoke_source_function("tokenize", *args, **kwargs)
      end
    end
  end
end
