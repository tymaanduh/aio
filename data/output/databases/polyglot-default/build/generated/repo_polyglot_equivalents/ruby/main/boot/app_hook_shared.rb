...
module Aio
  ...
  "run_hook": "run_hook"
      ...
      def self.create_app_hook_result(*args, **kwargs)
        invoke_source_function("create_app_hook_result", *args, **kwargs)
      end

      def self.create_app_hook_runner(*args, **kwargs)
        invoke_source_function("create_app_hook_runner", *args, **kwargs)
      end

      def self.create_app_hook_spec(*args, **kwargs)
        invoke_source_function("create_app_hook_spec", *args, **kwargs)
      end
