...
module Aio
  ...
  "safeRecordDiagnosticError": "safe_record_diagnostic_error"
      ...
      def self.create_renderer_state_context(*args, **kwargs)
        invoke_source_function("createRendererStateContext", *args, **kwargs)
      end

      def self.safe_record_diagnostic_error(*args, **kwargs)
        invoke_source_function("safeRecordDiagnosticError", *args, **kwargs)
      end
    end
  end
end
