...
module Aio
  ...
  "run_hook": "run_hook"
      ...
      def self.create_window_hook_pair(*args, **kwargs)
        invoke_source_function("create_window_hook_pair", *args, **kwargs)
      end

      def self.create_window_hook_result(*args, **kwargs)
        invoke_source_function("create_window_hook_result", *args, **kwargs)
      end

      def self.create_window_hook_spec(*args, **kwargs)
        invoke_source_function("create_window_hook_spec", *args, **kwargs)
      end
