...
module Aio
  ...
  "createEntryIndexTools": "create_entry_index_tools"
      ...
      def self.build_entries_index(*args, **kwargs)
        invoke_source_function("buildEntriesIndex", *args, **kwargs)
      end
      ...
      def self.create_entry_index_tools(*args, **kwargs)
        invoke_source_function("createEntryIndexTools", *args, **kwargs)
      end
    end
  end
end
