...
module Aio
  ...
  "normalizeUniverseGraphNode": "normalize_universe_graph_node"
      ...
      def self.normalize_universe_cache_state(*args, **kwargs)
        invoke_source_function("normalizeUniverseCacheState", *args, **kwargs)
      end

      def self.normalize_universe_graph_edge(*args, **kwargs)
        invoke_source_function("normalizeUniverseGraphEdge", *args, **kwargs)
      end

      def self.normalize_universe_graph_node(*args, **kwargs)
        invoke_source_function("normalizeUniverseGraphNode", *args, **kwargs)
      end
    end
  end
end
