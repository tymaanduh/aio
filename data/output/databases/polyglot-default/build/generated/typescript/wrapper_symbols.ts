export const WRAPPER_SYMBOL_REGISTRY = {
  "schema_version": 1,
...
export function mathAbs(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_ABS, boundArgs);
}

export function mathAdd(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_ADD, boundArgs);
}

export function mathAssign(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_ASSIGN, boundArgs);
}

export function mathChainAssign(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_CHAIN_ASSIGN, boundArgs);
}

export function mathClamp(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_CLAMP, boundArgs);
}

export function mathDivide(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_DIVIDE, boundArgs);
}

export function mathEqual(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_EQUAL, boundArgs);
}

export function mathMax(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_MAX, boundArgs);
}

export function mathMin(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_MIN, boundArgs);
}

export function mathMultiply(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_MULTIPLY, boundArgs);
}

export function mathSubtract(boundArgs: Record<string, unknown> = {}): WrapperResult {
  return runWrapperFunction(FUNCTION_IDS.MATH_SUBTRACT, boundArgs);
}

export const WRAPPER_FUNCTION_MAP: Record<string, (boundArgs?: Record<string, unknown>) => WrapperResult> = {
  "math.abs": mathAbs,
  "math.add": mathAdd,
  "math.assign": mathAssign,
  "math.chain_assign": mathChainAssign,
