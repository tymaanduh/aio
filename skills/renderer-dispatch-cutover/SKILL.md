...
2. `data/shared/renderer/dispatch_specs.js` exists and is the source of truth for dispatch mapping.
...
2. Build dispatch factory helpers in `app/modules/renderer_dispatch_domain.js`.
...
rg -n "PATTERN_EXTRACTED_MODULE|group_set_|DISPATCH_SPEC_MAP" app/renderer.js data/shared/renderer/group_sets.js data/shared/renderer/dispatch_specs.js
