...
function create_repository_domain_keys() {
  return {
    STATE: "state",
    AUTH: "auth",
...
const REPOSITORY_DOMAIN_KEYS = Object.freeze(create_repository_domain_keys());

function create_repository_spec_map() {
  return {
...
const REPOSITORY_SPEC_MAP = Object.freeze(create_repository_spec_map());
