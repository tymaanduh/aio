...
const UNIVERSE_EXPORT_RULES = Object.freeze({
...
async function export_universe(payload) {
  ...
  if (format === UNIVERSE_EXPORT_RULES.PNG_FORMAT) {
    ...
    const file_path = build_user_data_export_path(UNIVERSE_EXPORT_RULES.FILE_PREFIX, UNIVERSE_EXPORT_RULES.PNG_EXTENSION);
  ...
  const file_path = build_user_data_export_path(UNIVERSE_EXPORT_RULES.FILE_PREFIX, UNIVERSE_EXPORT_RULES.JSON_EXTENSION);
