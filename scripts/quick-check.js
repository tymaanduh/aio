      ...
      ws.on("open", () => {
        ...
        const ev = async (expr) => {
          ...
          if (msg.result && msg.result.exceptionDetails)
            return "JS_ERROR: " + (msg.result.exceptionDetails.text || "unknown");
        ...
        (async () => {
          ...
          const checks = [
            ...
            [
              "search visible",
              "!!(document.getElementById('treeSearchInput') && document.getElementById('treeSearchInput').offsetParent)"
            ],
            [
              "logout visible",
              "!!(document.getElementById('logoutAction') && document.getElementById('logoutAction').offsetParent)"
            ],
            [
              "save visible",
              "!!(document.getElementById('entrySaveAction') && document.getElementById('entrySaveAction').offsetParent)"
            ],
            ["tree children", "document.getElementById('treeView').children.length"],
            [
              "export visible",
              "!!(document.getElementById('exportDataAction') && document.getElementById('exportDataAction').offsetParent)"
            ],
            [
              "labelFilter visible",
              "!!(document.getElementById('treeLabelFilter') && document.getElementById('treeLabelFilter').offsetParent)"
            ],
            [
              "newEntry visible",
              "!!(document.getElementById('newEntryAction') && document.getElementById('newEntryAction').offsetParent)"
            ],
