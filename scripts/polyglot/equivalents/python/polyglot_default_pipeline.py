#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/polyglot-default-pipeline.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/polyglot-default-pipeline.js", sys.argv[1:]))
