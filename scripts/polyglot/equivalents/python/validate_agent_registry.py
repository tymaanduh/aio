#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/validate-agent-registry.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/validate-agent-registry.js", sys.argv[1:]))
