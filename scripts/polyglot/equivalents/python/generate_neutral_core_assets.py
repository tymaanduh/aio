#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/generate-neutral-core-assets.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/generate-neutral-core-assets.js", sys.argv[1:]))
