#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/generate-documentation-suite.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/generate-documentation-suite.js", sys.argv[1:]))
