#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/word-machine-descriptor-compile.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/word-machine-descriptor-compile.js", sys.argv[1:]))
