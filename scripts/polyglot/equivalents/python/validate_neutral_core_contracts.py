#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/validate-neutral-core-contracts.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/validate-neutral-core-contracts.js", sys.argv[1:]))
