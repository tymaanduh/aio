#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/lib/polyglot-script-swap-runner.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/lib/polyglot-script-swap-runner.js", sys.argv[1:]))
