#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/lib/in-process-script-runner.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/lib/in-process-script-runner.js", sys.argv[1:]))
