#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/lib/documentation-decision-changelog.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/lib/documentation-decision-changelog.js", sys.argv[1:]))
