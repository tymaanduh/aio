#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/lib/agent-access-policy.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/lib/agent-access-policy.js", sys.argv[1:]))
