#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/iso-standards-compliance-gate.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/iso-standards-compliance-gate.js", sys.argv[1:]))
