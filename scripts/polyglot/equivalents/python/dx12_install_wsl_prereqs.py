#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/dx12-install-wsl-prereqs.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/dx12-install-wsl-prereqs.js", sys.argv[1:]))
