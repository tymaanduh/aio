#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/validate-workflow-pipeline-order.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/validate-workflow-pipeline-order.js", sys.argv[1:]))
