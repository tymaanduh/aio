#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/project-source-resolver.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/project-source-resolver.js", sys.argv[1:]))
