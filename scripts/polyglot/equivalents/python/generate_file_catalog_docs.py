#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/generate-file-catalog-docs.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/generate-file-catalog-docs.js", sys.argv[1:]))
