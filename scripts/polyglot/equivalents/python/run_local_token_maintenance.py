#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/run-local-token-maintenance.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/run-local-token-maintenance.js", sys.argv[1:]))
