#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/validate-codex-desktop-compat.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/validate-codex-desktop-compat.js", sys.argv[1:]))
