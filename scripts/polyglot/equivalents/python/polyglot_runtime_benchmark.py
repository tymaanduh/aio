#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/polyglot-runtime-benchmark.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/polyglot-runtime-benchmark.js", sys.argv[1:]))
