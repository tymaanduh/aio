#!/usr/bin/env python3
"""Auto-generated Python equivalent for scripts/generate-wrapper-polyglot-bindings.js."""
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_native_script("scripts/generate-wrapper-polyglot-bindings.js", sys.argv[1:]))
